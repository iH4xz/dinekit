...
const VALID_VIEWS = [ 'home', 'reports', 'builder', 'design', 'qr', 'orders', 'kds', 'pos', 'hours', 'bookings', 'floor', 'events', 'guests', 'reviews', 'staff', 'support', 'integrations', 'emails', 'access', 'activity', 'settings' ];
